  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await api.post('/api/counselor/sessions', {
        ...
        emotionalStateObserved: form.emotionalStateObserved.trim(),
        emotionalStateEnd: form.emotionalStateEnd.trim(),
        sessionNarrative: form.sessionNarrative.trim(),
        interventionsApplied: form.interventionsApplied.trim(),
