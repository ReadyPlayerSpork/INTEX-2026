      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 max-w-3xl">
          ...
          <p className="text-muted-foreground mt-4 text-pretty text-lg leading-8">
            Here is a realistic look at our operations and outcomes. We track our effectiveness so partners and donors know where resources go and how lives are changing—using the same resident-level signals that power our outcome models.
          </p>
        </div>
          ...
          <Stat
            ...
            hint={
              impact?.basedOnTrailingTwelveMonths
                ...
                : 'Based on all-time monetary USD in our system� 52 weeks� active residents when recent data is thin (illustrative).'
            }
          />
          <Stat
