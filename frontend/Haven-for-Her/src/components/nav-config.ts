...
export const navLinkClassName =
  'text-muted-foreground hover:bg-secondary hover:text-foreground rounded-full px-3 py-2 text-sm font-medium motion-safe:transition-[background-color,color] motion-safe:duration-200 focus-visible:border-ring focus-visible:ring-ring/20 outline-none focus-visible:ring-4'
